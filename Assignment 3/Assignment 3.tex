...
%
\begin{lstlisting}
https://github.com/CS20BTECH11004/AI1103/blob/main/Assignment%203/Assignment%203.tex
\end{lstlisting}

\section*{Question: GATE EC Q32}
A probability density function is of the form 
\begin{align}
    p(x)&=Ke^{-\alpha \abs{x}},x\in(-\infty,\infty)\nonumber
\end{align}
The value of K is
...
\begin{align}
    \Integral{-\infty}{\infty} p(x)dx&=\Integral{-\infty}{\infty} K e^{-\alpha \abs{x}}dx\\
                                    ...
                                    &=\frac{2K}{\alpha}\label{a}
\end{align}
We know
\begin{align}
    \Integral{-\infty}{\infty} p(x)dx=1\label{b}
\end{align}
